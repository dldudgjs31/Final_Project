...
<Br>
    ...
    <form name="searchForm" action="${pageContext.request.contextPath}/store/customer/buylist" method="post">
     ...
     <p class="text-right">  총 주문 내역 수  : ${dataCount} &nbsp;&nbsp;&nbsp; (${page}/${total_page} 페이지)</p>
		...
		<c:forEach var="dto" items="${list}">
			<tr>
				...
				<td><fmt:formatNumber type="currency" value="${dto.total_sales}" />원</td>
