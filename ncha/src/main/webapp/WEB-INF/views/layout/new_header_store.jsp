...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top" style="font-family: 'Jua', sans-serif; font-size: 15px;">
    <div class="container">
      <a class="navbar-brand" href="${pageContext.request.contextPath}/store/main"><img alt="로고" src="${pageContext.request.contextPath}/resources/img/logo2.png" style="width:150px;"></a>
