...
<div class="row">
	...
	<div class="col-lg-3 mb-4">
		<div class="list-group">
			<a href="${pageContext.request.contextPath}/event/proceedList"
				class="list-group-item">진행중 이벤트</a> <a
				href="${pageContext.request.contextPath}/event/endList"
				class="list-group-item">종료된 이벤트</a> <a
				href="${pageContext.request.contextPath}/event/list"
				class="list-group-item">전체 이벤트</a>
		</div>
	</div>
	<!-- Content Column -->
			...
			<c:forEach var="dto" items="${list}">
				<div class="col-lg-4 col-sm-6 portfolio-item"
					...
					<div class="card h-100">
						<a href="${articleUrl}&eventNum=${dto.eventNum}"><img
							class="card-img-top"
						...
						<div class="card-body">
							...
							<p class="card-text">
								진행 기간 <br> <span style="font-style: italic;">
									${dto.start_date}~ ${dto.end_date} </span>
							</p>
						</div>
					</div>
				</div>
